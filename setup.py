...
PACKAGE_NAME = "pyggseg"
BUILD_REQUIRES = ["numpy", "scipy", "argparse", "matplotlib", "pandas", "nibabel", "rpy2"]
...
exec(open('pyggseg/version.py').read())
setup(name = PACKAGE_NAME, version = __version__, include_package_data=True,
  ...
  description="pyggseg",
  long_description="",
  url="https://github.com/trislett/pyggseg.git",
  download_url="",
